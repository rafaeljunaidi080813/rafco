...
import email from 'common/src/assets/image/agencyModern/icons/email.png';
import phone from 'common/src/assets/image/agencyModern/icons/phone.png';
import whatsapp from 'common/src/assets/image/agencyModern/icons/whatsapp.png';
import facebook from 'common/src/assets/image/agencyModern/icons/facebook.png';
import linkedin from 'common/src/assets/image/agencyModern/icons/linkedin.png';
import Instagram from 'common/src/assets/image/agencyModern/icons/instagram.png';
  ...
  alamat: [
    {
      id: 1,
      icon: email,
      title: 'Perkantoran Tanjung Mas Raya Blok B1 nomor 44,',
    },
    {
      id: 2,
      icon: phone,
      title: 'Tanjung Barat, Jagakarsa – Jakarta Selatan ',
    },
    {
      id: 2,
      icon: whatsapp,
  ...
  contact: [
    {
      id: 1,
      icon: email,
      title: 'rafcompany2020@gmail.com',
      link: 'mailto:rafcompany2020@gmail.com'
    },
    {
      id: 2,
      icon: phone,
