...
import FeatureImage from 'common/src/assets/image/agency/agency-banner-1.jpg';
        ...
        <Box className="row" {...row}>
          <Box className="col" {...col} {...textArea}>
            <FeatureBlock
              title={
                <Heading
                  content="Selalu up to date."
                  {...title}
                />
              }
              description={
                <Text
                  content="Kami selalu beradaptasi dengan cepat terhadap perkembangan teknologi untuk memberikan pelayanan terbaik kepada klien kami, misalnya menggunakan bahasa pemprograman terbaru: golang, php, ruby on rails."
                  {...description}
                />
              }
            />
